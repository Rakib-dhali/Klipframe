...
export default function ContactSection() {
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Contact" text2="Get in touch" text3="Ready to level up your thumbnails? Let's connect and help your channel grow." />
            <form onSubmit={(e) => e.preventDefault()} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl mx-auto text-slate-300 mt-16 w-full' >
                ...
                >
                    ...
                    <textarea name='message' rows={8} placeholder='Enter your message' className='focus:border-blue-500 resize-none w-full p-3 outline-none rounded-lg border border-slate-700' />
                </motion.div>
