...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Testimonials" text2="Don't just take our words" text3="Hear what creators say about KlipFrame. We're always improving to help you grow. If KlipFrame has levelled up your thumbnail game, we'd love to hear your story." />
