...
export default function HeroSection() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <motion.a  className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-blue-100 bg-blue-200/15"
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>50 free thumbnail credits </span>
            ...
            >
                Create scroll-stopping <span className="move-gradient px-3 rounded-xl text-nowrap">thumbnails</span> in seconds
            ...
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Stop spending hours in Photoshop. Let AI do it for you.</motion.p>
            ...
            >
                <button onClick={() => navigate("/generate")} className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-7 h-11">
                    Generate Now
                </button>
