    ...
    return (
        ...
        >
            <motion.div className="relative transform-3d w-full max-w-4xl" style={{ rotateX, rotateY }} >
                <motion.img src="/assets/hero-image.png"
                    className="w-full border p-1 bg-linear-180 from-blue-200 to to-transparent rounded-[15px] will-change-transform transform-[translateZ(0)]"
