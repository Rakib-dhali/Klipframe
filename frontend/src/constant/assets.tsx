import type { ColorScheme, ModelOption, ThumbnailStyle } from "../types";
import { Sparkle, Square, Image, Cpu, PenTool } from "lucide-react";
...
export const thumbnailStyles: ThumbnailStyle[] = [
  {
    label: "Bold & Graphic",
    desc: "High-contrast, bold design elements",
    icon: <Sparkle />,
  },
  {
    label: "Minimalist",
  ...
  },
  {
    ...
    desc: "Highly detailed, realistic imagery",
    icon: <Image />,
  },
  {
    label: "Illustrated",
    desc: "Artistic, hand-drawn style illustrations",
    icon: <PenTool />,
  },
  {
    label: "Tech/Futuristic",
    desc: "Modern, tech-inspired aesthetic",
    icon: <Cpu />,
  },
];
